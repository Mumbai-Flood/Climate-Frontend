  ...
  return (
    <div className="relative w-full max-w-md mx-auto">
      <div className="relative">
        <div
          className={`flex items-center overflow-hidden bg-gray-900/90 backdrop-blur-sm border border-gray-700 
        ...
        {showOptions && filteredStations.length > 0 && (
          <div
            className="absolute w-full mt-0.5 max-h-60 overflow-y-auto rounded-b-lg bg-gray-900/90 backdrop-blur-md 
