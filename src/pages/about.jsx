            ...
            <div className='page-content'>
                ...
                <section className='mb-8 sm:mb-16'>
                    ...
                    <div className='max-w-4xl mx-auto space-y-4 sm:space-y-6 text-gray-700 px-4 sm:px-0'>
                        ...
                        <p className='text-base sm:text-lg'>
                            By disseminating near-real-time rainfall and waterlogging information through our dedicated website portal{' '}
                            <a href="https://www.mumbaiflood.in/" className='text-blue-600 hover:text-blue-800 transition-colors'>
                                mumbaiflood.in
                            </a>
                            {' '}and the MUMBAI FLOOD APP, we aim to provide Mumbaikars with timely and accurate rainfall forecast and flood updates to help them plan their rain days ahead.
                        </p>
                ...
                <section className='mb-8 sm:mb-16'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8'>
                        <div className='partner-card p-4'>
                            <h3 className='text-lg sm:text-xl font-semibold mb-4 text-center text-gray-700'>Academic Partners</h3>
                            <div className='flex justify-center items-center gap-4'>
                                <img src={iitbLogo} alt="IIT Bombay" className='h-16 sm:h-20 object-contain hover:scale-105 transition-transform' />
                                <img src={csLogo} alt="Climate Studies" className='h-12 sm:h-16 object-contain hover:scale-105 transition-transform' />
                            </div>
                        </div>
                        <div className='partner-card p-4'>
                            <h3 className='text-lg sm:text-xl font-semibold mb-4 text-center text-gray-700'>Sponsoring Partner</h3>
                            <div className='flex justify-center items-center gap-4'>
                                <img src={hdfcLogo} alt="HDFC ERGO" className='h-20 sm:h-24 object-contain hover:scale-105 transition-transform' />
                                <img src={hdfcLogo1} alt="HDFC" className='h-12 sm:h-16 object-contain hover:scale-105 transition-transform' />
                            </div>
                        </div>
                        <div className='partner-card p-4'>
                            <h3 className='text-lg sm:text-xl font-semibold mb-4 text-center text-gray-700'>Project Partner</h3>
                            <div className='flex justify-center items-center'>
                                <img src={mcmrLogo} alt="MCGM Center" className='h-16 sm:h-20 object-contain hover:scale-105 transition-transform' />
                            </div>
                        </div>
                        <div className='partner-card p-4'>
                            <h3 className='text-lg sm:text-xl font-semibold mb-4 text-center text-gray-700'>Data Source</h3>
                            <div className='flex justify-center items-center'>
                                <img src={bmc} alt="BMC" className='h-16 sm:h-20 object-contain hover:scale-105 transition-transform' />
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className='mb-8 sm:mb-16'>
                    ...
                    <div className='max-w-4xl mx-auto space-y-4 sm:space-y-6 text-gray-700 px-4 sm:px-0'>
                        ...
                        <ol className='list-decimal space-y-3 sm:space-y-4 pl-6 text-sm sm:text-base'>
                            <li>Ward officers, Executive Engineers, Assistant Engineers, and Junior Engineers of the H West, F South, F North, E and L Wards for granting permissions and helping in identifying flooding hotspots;</li>
                            <li>Faculty at the Department of Geography, University of Mumbai for their collaborative efforts in the flood monitoring experiment. We thank the VC, Registrar and the Campus Development Unit of the University of Mumbai for granting space and electricity for installing the canal sensor on MU campus;</li>
                            <li>Executive Engineer, Assistant Engineer, and other staff at the Water Works Department, Municipal Corporation of Greater Mumbai (MCGM), Powai for allowing us to use their premises for installing canal sensor on Mithi River;</li>
                            <li>Divisional Engineer Street Lights Maintenance (DESLM), Brihanmumbai Electricity Supply and Transport Undertaking (BEST) for allowing installation of road sensors on BEST poles;</li>
                            <li>Chief Engineer and Officials of Customer Care, Electric Supply, BEST for prompt response to electrical connection requests;</li>
                            <li>Secretary, Chairman and Residents of Mandarpan Coop Housing society, RA Kidwai Road Wadala for their cooperation and no objection to installing electric meter in their premises;</li>
                            <li>Mr Omkar Sunil Chavan and the residents of his compound for their cooperation and support for installing canal sensor at Andheri Subway;</li>
                            <li>Officials and Staff at Adani Electricity for prompt response to application request for electric meters.</li>
                        </ol>
                    </div>
                </section>
                    ...
                    <div className='flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8'>
                        <div className='text-center sm:text-left space-y-3 sm:space-y-4'>
                            ...
                            <p className='text-sm sm:text-base text-gray-600 max-w-md'>
                                Stay updated with real-time flood alerts and rainfall forecasts. Download our app to access all features on the go.
                            </p>
                        </div>
