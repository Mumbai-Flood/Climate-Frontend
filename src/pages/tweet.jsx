    ...
    return (
        <div className="page-container bg-white">
            ...
            <div className="flex flex-col sm:flex-row h-[calc(100vh-10rem)] sm:h-[calc(100vh-4rem)]">
                {/* Map Section */}
                <div className={`${isMapView ? 'block' : 'hidden'} sm:block w-full sm:w-1/2 h-full sm:h-5/6 p-2`}>
                                    ...
                                    >
                                        <Popup className="popup-content"> 
                                            <p className='text-sm font-normal'>
                                                {mapdata.tweet_text}
                                                <hr className="my-2" />
                                                <span className="font-medium">Sentiment:</span> {mapdata.sentiment === false ? 'Negative' : 'Positive'}
                                                <br />
                ...
                <div className={`${!isMapView ? 'block' : 'hidden'} sm:block w-full sm:w-1/2 h-full p-4`}>
                    <h1 className="text-2xl sm:text-3xl font-bold text-center text-blue-700 mb-4">Tweet Analysis</h1>
                            ...
                            >
                                <p className="text-sm sm:text-base">
                                    ...
                                    <span className="text-sm">
                                        <span className="font-medium">Sentiment:</span> {tweet.sentiment === false ? 'Negative' : 'Positive'}
                                        <br />
